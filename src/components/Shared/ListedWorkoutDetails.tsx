    ...
    >
      ...
      <div className="flex items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
        ...
        <button
          ...
          className="flex-1 md:flex-none bg-[#c6fa00] hover:bg-[#b5e500] text-black text-sm font-bold px-5 py-2.5 rounded-full flex items-center justify-center gap-2 transition-colors"
        >
          <svg
...
export default ListedWorkoutDetails;